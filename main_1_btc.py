...
def strat(data_incoming):
    ...
    # normalize the training signals for training data
    ...
    # Normalize for testing signals for testing data
    ...
    # Define parameters for trading environment
